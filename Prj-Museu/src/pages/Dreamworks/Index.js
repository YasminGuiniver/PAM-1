...
export default function App() {
   function navegar(indiceAnimal){
      navigation.navigate("AnimaçãoDreamworks", {indice:indiceAnimal})
   }
        ...
        <View style={styles.brnArea2}>
            ...
            <View style={styles.botao2}  >
               <View style={styles.btnArea}>
                 <Text style={styles.btnTexto}>Arquitetura</Text>
                 
               </View>
               
            </View>
            
            <TouchableOpacity onPress={() => navegarInfo(2)}> <View style={styles.btnArea}><Image source={require('../../../assets/8687336_ic_fluent_line_horizontal_3_icon.png')} style={styles.imgD2}></Image></View></TouchableOpacity>
            </View>
            ...
            <Image source={require('../../../assets/MuseuGuggenheim.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/OscarNiemeyer.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/PalacioInverno.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/PotalaPalace.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/TajMahal.jpg')} style={styles.imgD4}></Image>
