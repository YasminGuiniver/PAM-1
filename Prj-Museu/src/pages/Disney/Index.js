        ...
        <View style={styles.brnArea2}>
            ...
            <View style={styles.botao2}  >
               <View style={styles.btnArea}>
                 <Text style={styles.btnTexto}>Pinturas</Text>
            ...
            <Image source={require('../../../assets/ColunaPartida.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/LagoaLiriosDagua.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/MulherSombrinha.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/Monalisa.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/NoiteEstrelada.jpg')} style={styles.imgD4}></Image>
            ...
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            <Image source={require('../../../assets/Girrassois.jpg')} style={styles.imgD4}></Image>
